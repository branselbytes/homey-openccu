...
export const HMIP_SWITCH_PROFILE: DeviceProfile = {
  id: "hmip-switch",
  driverId: "HMIP-PS",
  deviceTypes: ["HMIP-PS", "HmIP-PS", "HmIP-PCBS", "HmIP-PCBS-BAT", "HmIP-DRSI1"],
...
export const HMIP_POWER_METER_PROFILE: DeviceProfile = {
  ...
  bindings: [
    ...
    { capability: "measure_current", channel: 6, parameter: "CURRENT", transform: "milliamp-to-amp" },
    {
...
export const HMIP_CONTACT_PROFILE: DeviceProfile = {
  id: "hmip-contact",
  driverId: "HMIP-SWDO",
  deviceTypes: ["HMIP-SWDO", "HmIP-SWDO", "HmIP-SWDO-I", "HmIP-SWDM", "HmIP-SRH"],
  bindings: [
    { capability: "alarm_contact", channel: 1, parameter: "STATE", transform: "boolean" },
...
export const HMIP_CLIMATE_PROFILE: DeviceProfile = {
  id: "hmip-climate",
  driverId: "HmIP-STH",
  deviceTypes: ["HMIP-WTH", "HmIP-WTH", "HmIP-STH", "HmIP-STHD", "HmIP-STHO", "HmIP-BWTH"],
  bindings: [
    { capability: "measure_temperature", channel: 1, parameter: "ACTUAL_TEMPERATURE" },
    { capability: "measure_humidity", channel: 1, parameter: "HUMIDITY" },
    { capability: "target_temperature", channel: 1, parameter: "SET_POINT_TEMPERATURE" },
    {
